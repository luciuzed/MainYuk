  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 py-24 bg-white">
        ...
        <h1 className="text-[42px] sm:text-[56px] lg:text-[68px] font-extrabold text-gray-900 leading-tight max-w-[800px] mb-5">
          Temukan & Booking<br />
          <span className="text-[#00A859]">Venue Olahraga</span> Favoritmu
        </h1>
        <p className="text-[16px] sm:text-[18px] text-gray-500 max-w-[560px] mb-10 leading-relaxed">
          Ratusan venue terpercaya dari futsal hingga golf, tersebar di kota-kota besar Indonesia. Booking mudah, cepat, dan aman.
        </p>

        {/* Search Bar */}
        <div className="flex flex-col sm:flex-row gap-3 w-full max-w-[720px] bg-white border border-gray-200 rounded-2xl p-3 shadow-[0_4px_24px_rgba(0,0,0,0.07)]">
          <input
            type="text"
