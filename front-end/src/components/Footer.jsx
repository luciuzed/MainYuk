...
const Footer = () => {
  return (
    <footer className="bg-[#e6f7ef] border-t border-gray-100 pt-16 pb-8 px-6 mt-20 -mx-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pb-12 border-b border-primary/20">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/venue" className="text-gray-500 text-sm hover:text-[#009966] transition-colors">
                  Semua Venue
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/contact" className="text-gray-500 text-sm hover:text-[#009966] transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
